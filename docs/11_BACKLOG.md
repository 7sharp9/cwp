...
|---|---|---|---|---|---|---|
| TASK-001 | P0 | Establish repository and build baseline | S | project pack | active | `tasks/TASK-001-REPOSITORY-BASELINE.md` |
| TASK-002 | P1 | Create framework-neutral simulation skeleton | S | TASK-001 | ready after dependency | `tasks/TASK-002-SIMULATION-SKELETON.md` |
