...
| B-014 | P3 | Define command validation and recipient selection | S | B-011 | G3 | review (`tasks/TASK-020-COMMAND-VALIDATION-AND-RECIPIENTS.md`; implemented 2026-09-06, partial section 13 envelope) |
