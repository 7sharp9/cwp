...
- Reviewer: Dave
- Accepted: pending
- Notes: Do not activate TASK-005 or TASK-006 without Dave's review. ADR-0001
  is not decided by this task.
...
- Reviewer: Dave
- Accepted: pending
- Notes: Confirm the ADR-0003 amendment and the trimmed TASK-005 scope before
  TASK-005 is activated. ADR-0001 is not decided.
