...
| Green tests | `171` — `dotnet test CommandoWar.slnx -c Release` (`Passed: 171`; +3 over TASK-018's 168: `DeterminismPropertyTests.fs`'s three FsCheck properties, each run at 200 generated cases; the benchmark project contributes no tests) | TASK-019 |
