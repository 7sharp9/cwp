...
| Green tests | `159` — `dotnet test CommandoWar.slnx -c Release` (`Passed: 159`; +6 over TASK-015's 153 for the replay-corpus determinism theory and facts; the benchmark project contributes no tests) | TASK-016 |
