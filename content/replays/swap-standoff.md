...
| Tick count | 4 |
| Initial hash (tick 0) | `0x312F0DE0EC414A70` |
| Final hash (tick 4) | `0x647F40448319F615` |
| Domain events | 14 |
...
| tick | state hash          |
|-----:|---------------------|
|    1 | `0xC778F4421FD0AD66` |
|    2 | `0x1B8F977247FA711F` |
|    3 | `0x169CF35FF10CA294` |
|    4 | `0x647F40448319F615` |
